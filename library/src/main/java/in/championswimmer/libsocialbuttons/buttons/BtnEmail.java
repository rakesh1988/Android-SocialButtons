...
/**
 * Created by rakesh on 08-Jan-16.
 */
public class BtnEmail extends AppCompatButton
{
    public BtnEmail(Context context, AttributeSet attrs)
    {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.email);
        Drawable logo = getResources().getDrawable(R.drawable.logo_email);
